  ...
  return (
    <div className="tag-input flex max-w-2xl min-w-40 flex-col">
      ...
      <div className="border-background-color-2 dark:border-dark-background-color-2 mt-2 w-[90%] rounded-xl border-2 p-2">
        <div className="album-names-container empty:after:text-font-color-dimmed p-2 empty:py-2 empty:after:block empty:after:w-full empty:after:text-center empty:after:content-['No_album_selected_for_this_song.']">
          {songAlbum && (
            <div
              key={songAlbum.title}
