...
type Props = {
  songLanguage?: string;
  updateSongInfo: (_callback: (_prevSongInfo: SongTags & { language?: string }) => SongTags & { language?: string }) => void;
  onReset?: () => void;
};
    ...
    <div className="tag-input flex max-w-2xl min-w-[10rem] flex-col">
      <div className="flex items-center justify-between mr-[10%]">
        <label htmlFor="song-language-override-tag">
          {t('songTagsEditingPage.language', 'Language')}
        </label>
        {onReset && (
          <button
            type="button"
      ...
      <input
        ...
        name="song-language"
        placeholder={t('songTagsEditingPage.languagePlaceholder', 'e.g. English, Telugu, Spanish')}
        value={songLanguage ?? ''}
