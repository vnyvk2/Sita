  ...
  return (
    <div className="tag-input flex max-w-2xl min-w-40 flex-col">
      ...
      <div className="border-background-color-2 dark:border-dark-background-color-2 mt-2 w-[90%] rounded-xl border-2 p-2">
        <div className="artists-container empty:after:text-font-color-dimmed flex flex-wrap p-2 empty:py-2 empty:after:h-full empty:after:w-full empty:after:text-center empty:after:content-['No_artists_selected_for_this_song.']">
          {songArtists &&
