...
const ContextMenu = memo(() => {
  ...
  return (
    <div
      ...
      } absolute z-50 flex h-fit w-fit min-w-[15rem] origin-top-left flex-col overflow-visible rounded-lg shadow-[10px_0px_53px_0px_rgba(0,0,0,0.22)] backdrop-blur-md transition-[opacity,scale,transform,visibility,width,height]!`}
    ...
    >
      <div
        className={`main-menu-surface bg-context-menu-background/90 text-font-color-black dark:bg-dark-context-menu-background/90 dark:text-font-color-white flex max-h-[calc(100vh-80px)] w-full flex-col overflow-x-hidden overflow-y-auto rounded-lg ${
          !data && 'pt-1.5'
        } pb-1.5`}
      >
