        ...
        {topArtists.length === 0 ? (
          ...
          <div>
            ...
            <div className="flex items-end justify-center gap-2 pt-2 pb-4">
              {/* #2 Rank */}
              {top3[1] && (
                <div className="flex flex-col items-center text-center flex-1 max-w-[100px]">
                  <div className="relative mb-1">
                    ...
                    <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-slate-400 text-[10px] font-bold text-white shadow">
                      2
                    </span>
                  </div>
                  <div className="truncate w-full text-xs font-medium text-font-color-black dark:text-font-color-white">
                    {top3[1].name}
                  </div>
                  <div className="text-[10px] text-font-color-dimmed dark:text-dark-font-color-dimmed">
              ...
              {top3[0] && (
                <div className="flex flex-col items-center text-center flex-1 max-w-[120px] -mt-2">
                  <div className="relative mb-1">
                    ...
                    <span className="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-amber-400 text-xs font-bold text-amber-950 shadow">
                      👑
                    </span>
                  </div>
                  <div className="truncate w-full text-xs font-bold text-font-color-black dark:text-font-color-white">
                    {top3[0].name}
                  </div>
              ...
              {top3[2] && (
                <div className="flex flex-col items-center text-center flex-1 max-w-[100px]">
                  <div className="relative mb-1">
                    ...
                    <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-amber-700 text-[10px] font-bold text-white shadow">
                      3
                    </span>
                  </div>
                  <div className="truncate w-full text-xs font-medium text-font-color-black dark:text-font-color-white">
            ...
            {/* Rows 4..8 */}
            {remaining.length > 0 && (
              <div className="mt-2 border-t border-background-color-2/40 pt-2 flex flex-col gap-1">
                {remaining.map((artist, i) => (
                  <div
                    key={artist.artistId}
                    className="flex items-center justify-between gap-2 rounded-lg px-2 py-1 text-xs hover:bg-background-color-2/40 dark:hover:bg-dark-background-color-2/40"
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="w-3 text-[11px] text-font-color-dimmed dark:text-dark-font-color-dimmed">{i + 4}</span>
                      <span className="truncate font-medium text-font-color-black dark:text-font-color-white">
                        {artist.name}
                      </span>
                    </div>
                    <span className="text-[11px] font-semibold text-font-color-dimmed dark:text-dark-font-color-dimmed shrink-0">
