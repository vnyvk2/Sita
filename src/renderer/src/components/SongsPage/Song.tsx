  ...
  forwardRef((props: SongProp, ref: ForwardedRef<HTMLDivElement>) => {
    ...
    return (
      <div
        ...
        className={`${songId} fx-press group relative mr-4 mb-2 flex h-13 w-[98%] overflow-hidden rounded-lg p-[0.2rem] px-2 -outline-offset-2 transition-[background,color,opacity,transform] duration-150 ease-in-out focus-visible:outline! ${
