...
describe('UndoEngine', () => {
  ...
  beforeEach(async () => {
    ...
    // Alter identity columns to allow explicit inserts during test undo/redo
    await db.execute(sql`ALTER TABLE playlists ALTER COLUMN id SET GENERATED BY DEFAULT`);
    await db.execute(sql`ALTER TABLE playlist_entries ALTER COLUMN id SET GENERATED BY DEFAULT`);
    await db.execute(sql`ALTER TABLE operation_journal ALTER COLUMN id SET GENERATED BY DEFAULT`);
    await db.execute(sql`ALTER TABLE songs ALTER COLUMN id SET GENERATED BY DEFAULT`);
